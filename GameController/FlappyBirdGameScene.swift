...
class FlappyBirdGameScene: SKScene, SKPhysicsContactDelegate{
    ...
    var scoreUpdater: (NSInteger)->Void = { _ in }
    var gameOverScenario: (Void)->Void = {}
    ...
    override func didMove(to view: SKView) {
        ...
        for i in 0..<Int(2.0 + self.frame.size.width / ( skyTexture.size().width * 2.0 )) {
